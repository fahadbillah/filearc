...
class File extends CI_Controller {
	...
	{
		$result = $this->File_model->get_all_comments($id_files);
	...
	public function comment_submit()
	{
		...
		// vd($data);
		// exit();
		$result = $this->File_model->comment_submit($data);


		$returned_data = array(
		                       'success' => !!$result, 
		                       'message' => array(
		                                          'title' => (!!$result) ? 'Comment submitted successfully!' : 'Comment submit failed!' , 
		                                          'body' => '', 
		                                          ),
		                       );
